...
async function buildLdJson(container) {
  ...
  const ldJson = {
    ...
    author: {
      ...
      logo: {
        '@type': 'ImageObject',
        logo: 'https://www.famous-smoke.com/cigars-for-beginners/icons/footer-logo.svg',
        width: 147,
        height: 62,
      },
    },
...
function getFamousLogo() {
  ...
  const picture = createOptimizedPicture('/cigars-for-beginners/icons/footer-logo.svg', 'Famous Smoke Shop Logo');
